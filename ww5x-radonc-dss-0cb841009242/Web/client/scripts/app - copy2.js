...
function compute_correlations(organ_index, plan_index, selected_point, cdvh_array)
{
    ...
    console.log("array:" + selected_array)
...
// function abs_change(top_correlation_idx,cdvh_array){
//   temp = array.slice(cdvh_array)
// }

// function plotRadarChart(organ_index, plan_index, selected_point, cdvh_array){
//   corr_array = compute_correlations(organ_index, plan_index, selected_point, cdvh_array);
//   top_correlation_idx = topX(corr_array,4);  // need this to return [[1,2,3,4],[5,6,7,8]] where the first array is organ indices and second array is dose indices
//   abs_change = calculate_abs_change(top_correlations,cdvh_array);
// }
